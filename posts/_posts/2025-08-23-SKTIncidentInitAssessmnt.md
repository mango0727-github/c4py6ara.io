...
| **SUPI / SUCI**                     | SUPI: permanent subscriber ID. SUCI: radio-transmitted, concealed form of SUPI for privacy | SUPI: UDM/UDR <br> SUCI: generated on the UE on the fly using the home network public key | SUPI: UDM/UDR <br> SUCI de-conceal: SIDF                                                                        | SUPI types: IMSI or NAI. SUCI fields: SUPI type, Home-Network ID, Routing Indicator, Protection Scheme ID, HN Public Key ID, Scheme Output  |
