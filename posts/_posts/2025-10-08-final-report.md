...
![Figure 1. The diagram for the proposed model.]({{ '/assets/img/EE529final/figure1.png' | relative_url}}){:.lead width="800" height="100"}
...
![Figure 2. The stacked Denoising Autoencoder architecture.]({{ '/assets/img/EE529final/figure2.png' | relative_url}}){:.lead width="800" height="100"}
...
![Figure 3. Neural network classifier architecture.]({{ '/assets/img/EE529final/figure3.png' | relative_url}}){:.lead width="800" height="100"}
...
![Figure 4. Training of the SDAE and classifier.]({{ '/assets/img/EE529final/figure4.png' | relative_url}}){:.lead width="800" height="100"}
...
![Figure 5. Confusion matrix with and without SDAE.]({{ '/assets/img/EE529final/figure5.png' | relative_url}}){:.lead width="800" height="100"}
...
![Figure 6. Confusion matrix with deep bottleneck technique, accuracy = 98.54%.]({{ '/assets/img/EE529final/figure6.png' | relative_url}}){:.lead width="800" height="100"}
