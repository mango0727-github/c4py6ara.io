...
= \frac{ \dfrac{1}{d_1}\sum_{i=1}^{d_1}\dfrac{X_i^2}{\sigma_x^2} }{ \dfrac{1}{d_2}\sum_{i=1}^{d_2}\dfrac{Y_i^2}{\sigma_y^2} }
$$

where $X_i \sim N(0, \sigma_x^2)$ for $i=1, ..., d_1$ and $Y_i \sim N(0, \sigma_y^2)$ for $i=1, ..., d_2$, respectively. It is noteworthy that the standardized and squared random variables -- $X_i^2 / \sigma_x^2$ and $X_i^2 / \sigma_x^2$ -- follow the chi-squared distribution with 1 degree-of-freedom such that $V_1$ and $V_2$ follow the chi-square distribution with $d_1$ and $d_2$ degree-of-freedom.
