...
export const site = {
  ...
  title: 'Joonyoung Jeong',

  /** Site description. Used in meta tags. */
  description:
    'Joonyoung Jeong — cybersecurity researcher working on cellular network security (5G RAN/5GC), computer systems security, and malware analysis.',
  ...
  author: {
     ...
     * HTML is supported.
     */
    moreInfo: `<p>Korea Military Academy</p>
  ...
  socials: {
    ...
    cv_pdf: '/assets/pdf/joonyoung-jeong-cv.pdf',
  ...
  cv: {
    ...
    pdfPath: '/assets/pdf/joonyoung-jeong-cv.pdf',
  },
  ...
  blog: {
    ...
    name: 'Joon InfoSec Playground',
    description:
      'Random things that fascinate me — mainly information security, wireless tech, and horse riding.',
