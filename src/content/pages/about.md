---
title: "About (CV)"
description: "Cybersecurity Researcher. Beloved husband and daddy."
---

<!-- The PDF lives in public/assets/cv/. The path below must include the
     Astro `base` (/c4py6ara.io) because raw HTML is not base-rewritten. -->

<object
  data="/c4py6ara.io/assets/cv/joonyoung-jeong-cv.pdf"
  type="application/pdf"
  style="display:block;width:100%;height:90vh;min-height:600px;margin:0 0 2rem;border:0;"
>
  <p>
    Your browser cannot display PDFs inline.
    <a href="/c4py6ara.io/assets/cv/joonyoung-jeong-cv.pdf">Open the CV (PDF)</a> instead.
  </p>
</object>
