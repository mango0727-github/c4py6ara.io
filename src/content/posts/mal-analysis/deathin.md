---
title: "Malware Analysis Report: Skuld by Deathined"
description: "A very complex malware designed by deathined"
pubDatetime: 2025-05-21T12:00:00+09:00
tags:
  - "malware analysis"
---
...
![final.jpg](./assets/deathin/final.jpg)
...
![Figure 1. Malware analysis result on PEStudio](./assets/deathin/image.png)
...
![Figure 2. Ghidra_GolangAnalyzerExtension GitHub main screen](./assets/deathin/image-1.png)

Figure 2. Ghidra_GolangAnalyzerExtension GitHub main screen

![Figure 3. Install Extensions menu in the Ghidra main console](./assets/deathin/image-2.png)

Figure 3. Install Extensions menu in the Ghidra main console

![Figure 4. Popup window when selecting Install Extensions](./assets/deathin/image-3.png)

Figure 4. Popup window when selecting Install Extensions

![Figure 5. How to analyze with the extension after installing and restarting the extension.](./assets/deathin/image-4.png)

Figure 5. How to analyze with the extension after installing and restarting the extension.

![Figure 6. Restored result with Goresym alone](./assets/deathin/image-5.png)
...
![Figure 7. Pre-hardcoded error window message on Ghidra CodeBrowser](./assets/deathin/image-6.png)

Figure 7. Pre-hardcoded error window message on Ghidra CodeBrowser

![Figure 8. fake error warning window displayed when running the fakeerror function](./assets/deathin/image-7.png)
...
![Figure 9. Subroutines for anti-debugging in the antidebug.Run function in Ghidra CodeBrowser](./assets/deathin/image-8.png)
...
![Figure 10. Username checking routine in the isBlackListedUser function in Ghidra CodeBrowser](./assets/deathin/image-9.png)
...
![Figure 11. Computer name checking routine in the isBlackListedPC function on Ghidra CodeBrowser](./assets/deathin/image-10.png)
...
![Figure 12. Routine in the isBlackListedHWID function on Ghidra CodeBrowser](./assets/deathin/image-11.png)
...
![Figure 13. Routine for checking public IP and MAC address on Ghidra CodeBrowser](./assets/deathin/image-12.png)

Figure 13. Routine for checking public IP and MAC address on Ghidra CodeBrowser

![Figure 14. Ghidra CodeBrowser blacklist IP checking routine](./assets/deathin/image-13.png)

Figure 14. Ghidra CodeBrowser blacklist IP checking routine

![Figure 15. Routine for checking MAC addresses on Ghidra CodeBrowser](./assets/deathin/image-14.png)
...
![Figure 16. Screen Size Check Routine on Ghidra CodeBrowser](./assets/deathin/image-15.png)
...
![Figure 17. Memory size check routine on Ghidra CodeBrowser](./assets/deathin/image-16.png)
...
![Figure 21. Go routines on Ghidra CodeBrowser](./assets/deathin/image-20.png)
...
![Figure 22. BetterDiscord and DiscordTokenProtector bypass routine in injection.Run function on Ghidra CodeBrowser](./assets/deathin/image-21.png)
...
![Figure 23. Checking the Discord directory and injectDiscord routine in the injection.Run function on Ghidra CodeBrowser](./assets/deathin/image-22.png)

Figure 23. Checking the Discord directory and injectDiscord routine in the injection.Run function on Ghidra CodeBrowser

![Figure 24. Discord directory on x64dbg](./assets/deathin/image-23.png)
...
![Figure 25. Routines within the injectDiscord function on Ghidra CodeBrowser](./assets/deathin/image-24.png)

Figure 25. Routines within the injectDiscord function on Ghidra CodeBrowser

![Figure 26. Traversing the discord_desktop_core folder by the getCore function on x64dbg](./assets/deathin/image-25.png)

Figure 26. Traversing the discord_desktop_core folder by the getCore function on x64dbg

![Figure 27. Injection target file (index.js) inside the discord_desktop_core folder](./assets/deathin/image-26.png)
...
![Figure 28. host_url, the third argument of net/http.(*Client).Get() function with no data on Ghidra CodeBrowser](./assets/deathin/image-27.png)

Figure 28. host_url, the third argument of net/http.(*Client).Get() function with no data on Ghidra CodeBrowser

![Figure 29. RCX (host_url) is zeroed out even between dynamic analysis on x64dbg](./assets/deathin/image-28.png)
...
![Figure 30. Routine in discords.Run function for collecting data on Ghidra CodeBrowser](./assets/deathin/image-29.png)

Figure 30. Routine in discords.Run function for collecting data on Ghidra CodeBrowser

![Figure 31. List of identified browsable folders on x64dbg](./assets/deathin/image-30.png)

Figure 31. List of identified browsable folders on x64dbg

![Figure 32. Identified browse target file on x64dbg: discord_backup_codes](./assets/deathin/image-31.png)

Figure 32. Identified browse target file on x64dbg: discord_backup_codes

![Figure 33. Routine for generating data in json file format for sending webhooks on Ghidra CodeBrowser](./assets/deathin/image-32.png)

Figure 33. Routine for generating data in json file format for sending webhooks on Ghidra CodeBrowser

![Figure 34. Discord webhook: Sending data as HTTP POST request to Discord address (hxxps[://]discord[.]com/api/webhooks/1101151106052145214/BIaHrwzWkurP1ifNTfI0S-nV_adpU3L7CtHkZgsoxNh0xWIhQpjX2fdzD9kB7BDNYQi7)](./assets/deathin/image-33.png)
...
![Figure 35. Ghidra CodeBrowser's browser.Run function's Gecko and Chromium-based browser master key capture, information collection, and file compression routines.](./assets/deathin/image-34.png)
...
![Figure 36. Information gathering routine in chromium.Steal() function on Ghidra CodeBrowser](./assets/deathin/image-35.png)
...
![Figure 37. Local State navigation routine on Ghidra CodeBrowser](./assets/deathin/image-36.png)

Figure 37. Local State navigation routine on Ghidra CodeBrowser

![Figure 38. Local State contents (partially obscured for security reasons)](./assets/deathin/image-37.png)

Figure 38. Local State contents (partially obscured for security reasons)

![Figure 39. Masterkey base64 decoding and DPAPI decryption routine on Ghidra CodeBrowser](./assets/deathin/image-38.png)
...
![Figure 40. Routine to collect information only for the Default profile on Ghidra CodeBrowser. Parsing the condition of the If statement results in Opera or OperaGX.](./assets/deathin/image-39.png)
...
![Figure 41. Routine to collect information for all profiles on Ghidra CodeBrowser. Note Current_profile + 2.](./assets/deathin/image-40.png)
...
![Figure 42. Ghidra CodeBrowser creates directories and text files based on the collected information, and compresses the files.](./assets/deathin/image-41.png)
...
![Figure 43. Dropped browsers folder and browser.zip](./assets/deathin/image-42.png)

Figure 43. Dropped browsers folder and browser.zip

![Figure 44. Chrome and Edge folders present in the browsers folder](./assets/deathin/image-43.png)

Figure 44. Chrome and Edge folders present in the browsers folder

![Figure 45. text file with downloads, history information collected from the Default profile of the dropped Chrome browser](./assets/deathin/image-44.png)

Figure 45. text file with downloads, history information collected from the Default profile of the dropped Chrome browser

![Figure 46. Routines to generate json format data, send webhooks, and delete files on Ghidra CodeBrowser](./assets/deathin/image-45.png)
...
![Figure 47. Various data collection functions in the system.Run function on Ghidra CodeBrowser](./assets/deathin/image-46.png)
...
![Figure 48. Display information collection and screenshot capture routine on Ghidra CodeBrowser](./assets/deathin/image-47.png)

Figure 48. Display information collection and screenshot capture routine on Ghidra CodeBrowser

![Figure 49. Dropped screenshot png file](./assets/deathin/image-48.png)

Figure 49. Dropped screenshot png file

![Figure 50. Contents of the dropped screenshot file (0_1920x1080.png)](./assets/deathin/image-49.png)
...
![Figure 51. Host and User name collection routine on Ghidra CodeBrowser](./assets/deathin/image-50.png)
...
![Figure 52. Ghidra CodeBrowser HWID, CPU, Virtual memory, GPU information collection routine](./assets/deathin/image-51.png)
...
![Figure 53. Ghidra CodeBrowser Public IP and MAC Information Collection Routine](./assets/deathin/image-52.png)

Figure 53. Ghidra CodeBrowser Public IP and MAC Information Collection Routine

![Figure 54. Routine to collect country, city, region, zip code, etc. information on Ghidra CodeBrowser](./assets/deathin/image-53.png)
...
![Figure 55. Product key and product name collection routine using powershell on Ghidra CodeBrowser](./assets/deathin/image-54.png)

Figure 55. Product key and product name collection routine using powershell on Ghidra CodeBrowser

![Figure 56. Identified product key on x64dbg](./assets/deathin/image-55.png)

Figure 56. Identified product key on x64dbg

![Figure 57. Identified product name on x64dbg](./assets/deathin/image-56.png)
...
![Figure 58. Routine for sending webhook and deleting png file on Ghidra CodeBrowser](./assets/deathin/image-57.png)
...
![Figure 59. Routine to explore User Data\Local State or Local Data\Local State on Ghidra CodeBrowser](./assets/deathin/image-58.png)
...
![Figure 60. Routine to browse .log or .ldb file on Ghidra CodeBrowser](./assets/deathin/image-59.png)
...
![Figure 61. cord string detection routine from read data on Ghidra CodeBrowser](./assets/deathin/image-60.png)

Figure 61. cord string detection routine from read data on Ghidra CodeBrowser

![Figure 62. Searching for a disco token using a regular expression ([\\w-]{26}\\.[\\w-]{6}\\.[\\w-]{25,110}|mfa\\.[\\w-]{80,95}) in the absence of a string](./assets/deathin/image-61.png)
...
![Figure 63. x64dbg-identified token detection regex when no cord string is present](./assets/deathin/image-62.png)

Figure 63. x64dbg-identified token detection regex when no cord string is present

![Figure 64. Detecting a discovery token utilizing a regex (dQw4w9WgXcQ:[^\\\"]) when the string is present](./assets/deathin/image-63.png)

Figure 64. Detecting a discovery token utilizing a regex (dQw4w9WgXcQ:[^\\\"]) when the string is present

![Figure 65. x64dbg-identified token detection regular expression (when cord string is present)](./assets/deathin/image-64.png)

Figure 65. x64dbg-identified token detection regular expression (when cord string is present)

![Figure 66. Base64 decoding and decryption routine for token identified by Ghidra CodeBrowser](./assets/deathin/image-65.png)
...
![Figure 67. Routine for sending HTTP GET request with token to hxxps[://]discord[.]com/api/v9/users/@me in Ghidra CodeBrowser](./assets/deathin/image-66.png)

Figure 67. Routine for sending HTTP GET request with token to hxxps[://]discord[.]com/api/v9/users/@me in Ghidra CodeBrowser

![Figure 68. User Structure of the User Object, from [https://discord.com/developers/docs/resources/user#user-object](./assets/deathin/image-67.png)
...
![Figure 69. User Flags in User Object, from [https://discord.com/developers/docs/resources/user#user-object](./assets/deathin/image-68.png)
...
![Figure 70. Premium Types in User Object, from [https://discord.com/developers/docs/resources/user#user-object](./assets/deathin/image-69.png)
...
![Figure 71. Routine to get payment information in Ghidra CodeBrowser](./assets/deathin/image-70.png)
...
![Figure 72. Routine to get guild information in Ghidra CodeBrowser](./assets/deathin/image-71.png)
...
![Figure 73. Routine to get friend information in Ghidra CodeBrowser](./assets/deathin/image-72.png)
...
![Figure 74. Routine to get avatar information in Ghidra CodeBrowser](./assets/deathin/image-73.png)
...
![Figure 75. Routine to create the files directory in Ghidra CodeBrowser](./assets/deathin/image-74.png)

Figure 75. Routine to create the files directory in Ghidra CodeBrowser

![Figure 76. Dropped files folder in the working directory (desktop)](./assets/deathin/image-75.png)
...
![Figure 77. List of target folders for file browsing identified on x64dbg](./assets/deathin/image-76.png)
...
![Figure 78. Routine to copy files with target extensions to the files folder on Ghidra CodeBrowser](./assets/deathin/image-77.png)

Figure 78. Routine to copy files with target extensions to the files folder on Ghidra CodeBrowser

![Figure 79. Files with the dropped target extension in the files folder](./assets/deathin/image-78.png)
...
![Figure 80. Routine to compress the files folder into a zip file on Ghidra CodeBrowser](./assets/deathin/image-79.png)

Figure 80. Routine to compress the files folder into a zip file on Ghidra CodeBrowser

![Figure 81. files.zip dropped on the working directory (desktop)](./assets/deathin/image-80.png)
...
![Figure 82. Executing the GoFileUpload function with files.zip as an argument in Ghidra CodeBrowser](./assets/deathin/image-81.png)

Figure 82. Executing the GoFileUpload function with files.zip as an argument in Ghidra CodeBrowser

![Figure 83. Routine for sending an HTTP GET request to api[.]gofile[.]io/getServer on Ghidra CodeBrowser and processing the response](./assets/deathin/image-82.png)
...
![Figure 84. Description of api[.]gofile[.]io/servers in the gofile API documentation, from [https://gofile.io/api.](https://gofile.io/api)](./assets/deathin/image-83.png)
...
![Figure 85. Routine for uploading zip file via POST request to Gofile on Ghidra CodeBrowser](./assets/deathin/image-84.png)

Figure 85. Routine for uploading zip file via POST request to Gofile on Ghidra CodeBrowser

![Figure 86. Response packet structure for POST request to Go file server](./assets/deathin/image-85.png)
...
![Figure 87. Writing transfer data in json format including download link](./assets/deathin/image-86.png)

Figure 87. Writing transfer data in json format including download link

![Figure 88. Webhook sending routine on Ghidra CodeBrowser](./assets/deathin/image-87.png)
...
![Figure 89. The clipboard.watch function inside the clipper.Run function on Ghidra CodeBrowser.](./assets/deathin/image-88.png)
...
![Figure 90. The clipboard.watch function routine on Ghidra CodeBrowser, running watch.func1 and receiving data through the channel.](./assets/deathin/image-89.png)
...
![Figure 91. Calling Windows API, GetClipboardSenquenceNumber, on Ghidra CodeBrowser.](./assets/deathin/image-90.png)

Figure 91. Calling Windows API, GetClipboardSenquenceNumber, on Ghidra CodeBrowser.

![Figure 92. Windows API function GetClipboardSequenceNumber identified on x64dbg.](./assets/deathin/image-91.png)
...
![Figure 93. The clipboard read routine in the clipboard.watch.func1 function on Ghidra CodeBrowser.](./assets/deathin/image-92.png)
...
![Figure 94. Data traversal routine through regular expressions based on clipboard changes on Ghidra CodeBrowser.](./assets/deathin/image-93.png)
...
![Figure 95. Routine to overwrite the clipboard with the attacker's desired data on Ghidra CodeBrowser](./assets/deathin/image-94.png)
