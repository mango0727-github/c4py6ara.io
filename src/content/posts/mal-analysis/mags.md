...
description: "Detailed analysis on an exploit kit, Magnitude, and its payload, Magniber."
pubDatetime: 2025-06-20T12:00:00+09:00
tags:
  - "malware analysis"
---
...
![image.png](./assets/magniber/image.png)
...
![Figure 1. Encryption code inside hxxp[://]daonasset[.]kr/](./assets/magniber/image-1.png)
...
![Figure 2. Encryption code decryption result](./assets/magniber/image-2.png)
...
![Figure 3. Encoded hxxp[://]134[.]249[.]116[.]78/jquery[.]js in Fiddler](./assets/magniber/image-3.png)

Figure 3. Encoded hxxp[://]134[.]249[.]116[.]78/jquery[.]js in Fiddler

![Figure 4. Decrypted hxxp[://]134[.]249[.]116[.]78/jquery[.]js](./assets/magniber/image-4.png)
...
![Figure 5. Decrypted hxxp[://]errstock[.]tech/ redirected to URL of hxxp[://]2878d6fj42e1i09x[.]wentpi[.]com/ + hwlkrs with my code](./assets/magniber/image-5.png)
...
![Figure 6. Decoded script in  hxxp[://]2878d6fj42e1i09x[.]wentpi[.]com/0%7B95232%7B95520%7B106464%7B106368%7B88992%7B88896%7B0%7B1101360%7B2104320%7B26520%7B617760%7B26544%7B1176960%7B ](./assets/magniber/image-6.png)
...
![Figure 7. Base64-obfuscated VBScript in hxxp[://]576v7e3a1o[.]viewsup[.]party/ in Fiddler](./assets/magniber/image-7.png)
...
![Figure 8. Re-decryption result of some of the decrypted VBScripts](./assets/magniber/image-8.png)
...
![Figure 9. Identifying the GUID used in GetObject](./assets/magniber/image-9.png)

Figure 9. Identifying the GUID used in GetObject

![Figure 10. DLL download and injection routine inside hxxp[://]576v7e3a1o[.]viewsup[.]party/3b620f956dcae45951c1dc058f2b0b71](./assets/magniber/image-10.png)
...
![Figure 11. DLL PEStudio analysis result](./assets/magniber/image-11.png)
...
![Figure 12. PE-bear analysis results](./assets/magniber/image-12.png)
...
![Figure 13. DLL execution mimicking the behavior identified by Fiddler](./assets/magniber/image-13.png)
...
![Figure 14. Mutex identification in Process Explorer](./assets/magniber/image-14.png)
...
![Figure 15. Malicious DLL-related processes identified in Procmon's Process tree](./assets/magniber/image-15.png)

Figure 15. Malicious DLL-related processes identified in Procmon's Process tree

![Figure 16. Running Windows Default Programs via the computerdefaults command](./assets/magniber/image-16.png)

Figure 16. Running Windows Default Programs via the computerdefaults command

![Figure 17. Default program settings screen executed with the computerdefaults command](./assets/magniber/image-17.png)

Figure 17. Default program settings screen executed with the computerdefaults command

![Figure 18. Routine executed when running the Windows Setup program, adding key and value by the malicious DLL](./assets/magniber/image-18.png)
...
![Figure 19. Ransom note popup after executing the malicious file. This text file is present in every folder](./assets/magniber/image-19.png)

Figure 19. Ransom note popup after executing the malicious file. This text file is present in every folder

![Figure 20. Encrypted files are renamed with mutex extensions.](./assets/magniber/image-20.png)

Figure 20. Encrypted files are renamed with mutex extensions.

![Figure 21. A webpage pops up after executing the malicious DLL to send cryptocurrency.](./assets/magniber/image-21.png)
...
![Figure 22. Registry additions, deletions, and modifications by malicious DLLs](./assets/magniber/image-22.png)
...
![Figure 23. Registry keys added by malicious DLLs](./assets/magniber/image-23.png)

Figure 23. Registry keys added by malicious DLLs

![Figure 24. Modified value of registry (ms-setting subkey) key modified by the malicious DLL](./assets/magniber/image-24.png)

Figure 24. Modified value of registry (ms-setting subkey) key modified by the malicious DLL

![Figure 25. value decoding result, C:\Windows\system32\wbem\wmic process call create "vssadmin.exe Delete Shadows /all /quiet"](./assets/magniber/image-25.png)
...
![Figure 26. Calling the LoadLibrary function via indirect call](./assets/magniber/image-26.png)
...
![Figure 27. Defining a pointer to the GlobalAlloc function via indirect call](./assets/magniber/image-27.png)
...
![Figure 28. Shellcode decryption routine in the data section of the DLL](./assets/magniber/image-28.png)
...
![Figure 29. Shellcode fine-tuning routine according to Windows environment 2](./assets/magniber/image-29.png)

Figure 29. Shellcode fine-tuning routine according to Windows environment 2

![Figure 30. Different fine-tuning routines depending on whether you are on Windows 10 or not](./assets/magniber/image-30.png)

Figure 30. Different fine-tuning routines depending on whether you are on Windows 10 or not

![Figure 31. Different fine-tuning routines based on build number for Windows 10](./assets/magniber/image-31.png)
...
![Figure 32. As part of the KUSER_SHARED_DATA struct, the DLL utilizes offsets 0x0260 and 0x026C.](./assets/magniber/image-32.png)
...
![Figure 33. Shellcode Copy Routine](./assets/magniber/image-33.png)

Figure 33. Shellcode Copy Routine

After the copying is complete, the shellcode is executed.

![Figure 34. Executing shellcode after copying is completed](./assets/magniber/image-34.png)

Figure 34. Executing shellcode after copying is completed

![Figure 35. Shellcode execution routine on x64dbg](./assets/magniber/image-35.png)
...
![Figure 36. Mutax creation routine in shellcode](./assets/magniber/image-36.png)
...
![Figure 37. File encryption and folder-specific Readme.txt drop routine](./assets/magniber/image-37.png)
